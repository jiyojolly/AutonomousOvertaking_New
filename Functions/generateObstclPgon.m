function npcVehPgons = generateObstclPgon(npcVehLength, npcVehWidth, egoVehLength, egoVehWidth, Dmax, gamma, inflexPoint, inflationFactor,...
...
for i = 1:ActorsEgo.NumActors
    ...
    Tbvertex = getVelocityVertex(vLV, vEV, Dmax, gamma, inflexPoint);
